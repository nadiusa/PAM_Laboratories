...
class ComedyActivity : AppCompatActivity(){
    ...
    private lateinit var dramaMoviesList: MutableList<Movie>
    ...
    private fun initViews(){
        ...
        progressDialog.setMessage("Fetching Comedy movies...")
...
//                    }
                ...
                override fun onFailure(call: Call<MoviesResponse>, t: Throwable) {
                    ...
                    Toast.makeText(this@ComedyActivity, "Error Fetching Data!", Toast.LENGTH_SHORT).show()
                }
            })

        } catch (e : Exception){
            Log.d("Error", e.message)
            Toast.makeText(this@ComedyActivity, e.toString(), Toast.LENGTH_SHORT).show()
        }
    }
