...
class DetectiveActivity : AppCompatActivity() {
    ...
    private lateinit var detectiveMovieList: MutableList<Movie>
    ...
    private fun initViews(){
        ...
        progressDialog.setMessage("Fetching Detective movies...")
        ...
        movieList = listOf()
        detectiveMovieList = mutableListOf()
...
//            getGenreId()
            ...
            call.enqueue(object : Callback<MoviesResponse> {
                ...
                override fun onFailure(call: Call<MoviesResponse>, t: Throwable) {
                    ...
                    Toast.makeText(this@DetectiveActivity, "Error Fetching Data!", Toast.LENGTH_SHORT).show()
                }
            })

        } catch (e : Exception){
            Log.d("Error", e.message)
            Toast.makeText(this@DetectiveActivity, e.toString(), Toast.LENGTH_SHORT).show()
        }
    }
